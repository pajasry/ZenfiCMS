...
export class Init1659428486064 implements MigrationInterface {
    name = 'Init1659428486064'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "publicationStatuses" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, CONSTRAINT "UQ_fa4c166dc323f39248cfa686130" UNIQUE ("name"), CONSTRAINT "PK_dc41b063caa6a019138ee56b716" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "jwtTokens" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "value" character varying NOT NULL, "isRevoked" boolean NOT NULL DEFAULT false, CONSTRAINT "PK_c6148cff14b93cd25aa0adf1fb5" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "settings" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "googleAnalyticsId" character varying, CONSTRAINT "PK_0669fe20e252eb692bf4d344975" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "FK_0776809f9165d3c9e1b007917f8" FOREIGN KEY ("jwtTokenId") REFERENCES "jwtTokens"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" DROP CONSTRAINT "FK_0776809f9165d3c9e1b007917f8"`);
